...
public class AppboyTestCaseUnit3 {
    ...
    public void setUp() {
    	...
    	AppboyTestUtils.createTestEmailOptInData(4);
    	AppboyTestUtils.createOptOrderProcessData(2);    	
    }
	...
	public void testBadEmailFile() {	
		...
		AppboyTestUtils.createTestEmailOptInData();
	...
	public void testBadOrderFile() {	
		...
		AppboyTestUtils.createOptOrderProcessData();
