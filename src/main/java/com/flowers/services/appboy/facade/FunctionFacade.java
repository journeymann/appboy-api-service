...
import com.flowers.services.appboy.constants.TimeZones;
...
public class FunctionFacade {
	 ...
	 * the data that is to be pushed to the Appboy REST service.
	 ...
	 */
	public static String getJsonModeltoString(@NotNull final JSONObject model){
	 ...
	 * @return the <code>String</code> description for <code>Model</code> object cleansed xml content 
	 */
	public static String getJsonModeltoString(@NotNull final JSONObject model, boolean flag){
